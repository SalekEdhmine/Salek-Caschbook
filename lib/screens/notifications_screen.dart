...
class _PushPermissionBannerState extends State<_PushPermissionBanner> {
  ...
  Widget build(BuildContext context) {
    ...
    if (status != 'default' && status != 'unsupported') return const SizedBox.shrink();
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text(AppStrings.tr('notifications_push_enable_body'), style: const TextStyle(fontSize: 13)),
  ...
  Future<void> _enable() async {
    ...
    await PushService.instance.subscribe();
